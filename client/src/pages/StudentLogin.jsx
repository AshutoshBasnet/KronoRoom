      ...
      <div className="max-w-5xl w-full rounded-3xl border border-slate-800/80 bg-slate-950/80 shadow-2xl backdrop-blur-xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div>
            ...
            <div className="space-y-2 mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-white leading-snug">
                Campus Space Reservation, Simplified.
              </h2>
              <p className="text-xs text-slate-400 leading-relaxed">
                Secure, real-time access to institutional classrooms, computer labs, and auditorium spaces for academic success.
              </p>
            </div>
        ...
        <div className="w-full md:w-7/12 p-8 sm:p-10 flex flex-col justify-center bg-slate-900/40">
          <div className="max-w-md w-full mx-auto space-y-6">
            ...
            <div>
              <h3 className="text-xl font-bold text-white font-heading">Student Authorization</h3>
              <p className="text-xs text-slate-400 mt-1">
                Enter your London Met university credentials to manage seat allocations.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="studentID@londonmet.ac.uk"
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-300 uppercase tracking-wider mb-1.5" htmlFor="idCard">
                  London Met ID Card Number (Optional)
                </label>
                <input
                  id="idCard"
                  type="text"
            ...
            <div className="pt-4 border-t border-slate-800 space-y-2.5">
              <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider text-center">
                Quick-Fill Demo Credentials (PW: Password123)
              </p>
              <div className="grid grid-cols-3 gap-2 text-xs">
                <button
                  type="button"
                  onClick={() => handleDemoFill('a.basnet@londonmet.ac.uk', 'LM-STU-202401')}
                  className="px-2.5 py-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-200 border border-slate-700 text-center font-medium transition-colors cursor-pointer truncate"
                  title="Ashutosh Basnet"
                >
                  Ashutosh B.
                </button>
                <button
                  type="button"
                  onClick={() => handleDemoFill('a.poudel@londonmet.ac.uk', 'LM-STU-202402')}
                  className="px-2.5 py-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-200 border border-slate-700 text-center font-medium transition-colors cursor-pointer truncate"
                  title="Anmol Poudel"
                >
                  Anmol P.
                ...
                <button
                  type="button"
                  onClick={() => handleDemoFill('p.rai@londonmet.ac.uk', 'LM-STU-202403')}
                  className="px-2.5 py-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-200 border border-slate-700 text-center font-medium transition-colors cursor-pointer truncate"
                  title="Parjun Rai"
                >
                  Parjun R.
